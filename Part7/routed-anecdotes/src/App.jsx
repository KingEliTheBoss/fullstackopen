...
const Notification =({notif})=>{
  return (
    <div>a new anecdote: {notif} created!</div>
  );
}
...
const SingleAnecdote = ({ anecdote }) => (
  <div>
    ...
    <div>for info see {anecdote.info}</div><br></br>
  </div>
);
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Menu />
      {notification === "" ? null : <Notification notif={notification}/>}
      

      <Routes>
        <Route path='/' element={<AnecdoteList anecdotes={anecdotes} />} />
        <Route path='/anecdotes/:id' element={<SingleAnecdote anecdote={anecdoteByMatch} />} />
